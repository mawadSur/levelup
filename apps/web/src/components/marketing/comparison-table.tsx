...
const FEATURES: ReadonlyArray<FeatureRow> = [
  ...
  { label: 'Core AI learning paths', trial: true, starter: true, team: true, growth: true, enterprise: true },
  { label: 'In-context AI coach', trial: true, starter: true, team: true, growth: true, enterprise: true },
  { label: 'Admin dashboard', trial: true, starter: true, team: true, growth: true, enterprise: true },
  { label: 'Basic reporting', trial: true, starter: true, team: true, growth: true, enterprise: true },
  { label: 'Custom learning paths', trial: false, starter: false, team: true, growth: true, enterprise: true },
  { label: 'Department reporting', trial: false, starter: false, team: true, growth: true, enterprise: true },
  { label: 'Company AI policy integration', trial: false, starter: false, team: true, growth: true, enterprise: true },
  { label: 'Completion certificates', trial: false, starter: false, team: true, growth: true, enterprise: true },
  { label: 'SSO / SAML', trial: false, starter: false, team: false, growth: true, enterprise: true },
  { label: 'SCIM provisioning', trial: false, starter: false, team: false, growth: false, enterprise: true },
  { label: 'Advanced analytics', trial: false, starter: false, team: false, growth: true, enterprise: true },
  { label: 'Dedicated success manager', trial: false, starter: false, team: false, growth: false, enterprise: true },
  { label: 'SOC 2 attestation support', trial: false, starter: false, team: false, growth: false, enterprise: true },
  { label: 'Custom DPA / MSA', trial: false, starter: false, team: false, growth: false, enterprise: true },
  { label: 'Private deployment', trial: false, starter: false, team: false, growth: false, enterprise: true },
  {
    label: 'Support',
    trial: 'Community',
    starter: 'Email',
...
const TIER_HEADERS: ReadonlyArray<TierHeader> = [
  ...
  { tier: 'team', name: 'TEAM', pricing: { monthly: '$12/seat/mo', annual: '$10/seat/mo' }, highlight: true },
  { tier: 'growth', name: 'GROWTH', pricing: { monthly: '$15/seat/mo', annual: '$13/seat/mo' } },
  { tier: 'enterprise', name: 'ENTERPRISE', pricing: { monthly: 'From $25k/yr', annual: 'From $25k/yr' } },
];
