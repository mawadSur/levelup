...
// Experimental variant gated by 'pricing_v2' flag (Wave 4 / CR.27 scaffold).
// Replace this with the actual variant when the experiment design is
// finalized. Until then this is a verbatim copy of pricing-client.tsx so the
// gate ships non-destructively — visitors see byte-identical pricing whether
// they're bucketed into A or B. When the design lands, edit ONLY this file
// (do not touch pricing-client.tsx, which serves the V1 / control cohort).
...
export function PricingClientV2() {
