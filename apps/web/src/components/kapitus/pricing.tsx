    ...
    >
      <div className="mx-auto max-w-kp-container px-6 sm:px-8 lg:px-12">
        <div className="max-w-kp-reading">
          <p className="kp-eyebrow text-kp-blue">Pricing</p>
          <h2 className="kp-h1 mt-3 text-kp-navy">What it costs.</h2>
        ...
        <div className="mt-12 overflow-hidden rounded-kp-lg border border-kp-rule bg-kp-paper shadow-kp-sm">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr]">
            <div className="border-b border-kp-rule p-8 lg:border-b-0 lg:border-r lg:p-10">
              <p className="kp-eyebrow text-kp-blue">Standard tier</p>
              <p className="kp-h2 mt-3 text-kp-navy">100-seat team</p>
              <p
                className="mt-6 font-bold tabular-nums text-kp-navy"
                style={{ fontSize: '3rem', lineHeight: 1 }}
              >
                $25,000<span className="kp-body-lg text-kp-ink-mute">/year</span>
              </p>
              <p className="kp-body mt-4 text-kp-ink-soft">
                Starts at <span className="kp-data text-kp-navy">$25,000</span>{' '}
            ...
            <div className="bg-kp-mist p-8 lg:p-10">
              <p className="kp-eyebrow text-kp-blue">What&rsquo;s included</p>
